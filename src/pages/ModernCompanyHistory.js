...
import successCase1 from '../assets/images/success_case1.jpg';
import successCase1_1 from '../assets/images/success_case1-1.jpg';
import successCase2 from '../assets/images/success_case2.jpg';
import successCase2_1 from '../assets/images/success_case2-1.jpg';
import successCase2_2 from '../assets/images/success_case2-2.jpg';
import successCase3 from '../assets/images/success_case3.jpg';
import successCase3_1 from '../assets/images/success_case3-1.jpg';
import successCase4 from '../assets/images/success_case4.jpg';
import successCase4_1 from '../assets/images/success_case4-1.jpg';
...
const ModernCompanyHistory = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      features: ['用地計畫撰寫', '建築線申請', '各單位審查協調', '地政變更編定'],
      details: {
        content: [
  ...
  const successCases = [
    {
      ...
      title: '台中市特定工廠申請成功案例',
      category: '特定工廠登記',
      description: '誠泰地產管理有限公司協助成功申請特定工廠使用，土地面積0.111675公頃，順利完成從特定農業區變更為特定目的事業用地申請程序。',
      images: [successCase1, successCase1_1], // 多頁文件
    },
    {
      id: 2,
      title: '台中市非都市土地變更編定成功案例',
      category: '用地變更',
      description: '協助客戶成功申請特定農業區、農牧用地變更編定為「甲種建築用地」，土地面積0.020826公頃，取得台中市政府正式核准並完成市長盧秀燕簽章。',
      images: [successCase2, successCase2_1, successCase2_2], // 多頁文件
    },
    {
      id: 3,
      title: '南投縣農牧用地變更甲種建築用地成功案例',
      category: '用地變更',
      description: '協助客戶申請農牧用地變更編定為甲種建築用地，土地面積0.025721公頃，依據非都市土地使用管制規則第27條、第28條及第35條之1規定辦理，取得南投縣政府核准。',
      images: [successCase3, successCase3_1], // 多頁文件
    },
    {
      id: 4,
      title: '新竹縣土地使用編定變更成功案例',
      category: '土地使用編定變更',
      description: '協助林增家君申請土地使用編定變更案，面積0.003805公頃，依據非都市土地使用管制規則第35條第1項第5款及第2、5款相關規定辦理，取得新竹縣政府核准並完成縣長楊文科簽章。',
      images: [successCase4, successCase4_1], // 多頁文件
    },
    {
      id: 5,
      title: '舊有建物更正編定',
      category: '更正編定',
      description: '歷史建物編定錯誤問題獲得解決，釐清土地權利界線。',
      image: successCase1,
    },
    {
      id: 6,
      title: '複合型工廠用地整合',
      category: '特定工廠登記',
      description: '多筆土地整合申請，解決複雜的土地使用問題。',
      image: successCase2,
    }
  ];
  ...
  return (
    <div className="legal-services-template">
      {/* 導航列 */}
      <nav className="main-nav" role="navigation" aria-label="主要導航選單">
        <Container>
          <Row className="align-items-center">
            <Col md={4}>
              <div className="brand">
                <img src={logoImage} alt="誠泰地產管理有限公司 Logo - 專業工廠法規顧問" className="brand-logo" />
                <div className="brand-text">
                  <h1 className="brand-name">誠泰地產</h1>
      ...
      <section id="about" className="about-section" aria-labelledby="about-title">
        <Container>
          <Row>
            <Col lg={6}>
              <h2 id="about-title" className="about-title">公司沿革</h2>
            ...
            <Col lg={6}>
              <div className="about-visual">
                <img src={logoImage} alt="誠泰地產管理有限公司辦公室 - 台中專業不動產法規顧問" className="about-image" />
              </div>
            </Col>
            ...
            <Col lg={12} className="mt-4">
              ...
              <div className="success-carousel-container">
                <h3 className="carousel-title">代表性成功案例</h3>
                <Carousel className="success-cases-carousel" indicators={true} controls={true} interval={4000}>
                  {successCases.slice(0, 4).map((caseItem) => (
                    <Carousel.Item key={caseItem.id}>
                      <div className="carousel-case-wrapper">
                        <div className="carousel-case-image">
                          <img
                            src={caseItem.images ? caseItem.images[0] : caseItem.image}
                            alt={`${caseItem.title} - ${caseItem.category}`}
                            className="d-block w-100"
                          />
                          <div className="carousel-case-overlay">
                            <span className="carousel-case-category">{caseItem.category}</span>
                          </div>
                        </div>
                        <div className="carousel-case-content">
                          <h4 className="carousel-case-title">{caseItem.title}</h4>
                          <p className="carousel-case-description">{caseItem.description}</p>
                          <button 
                            className="carousel-case-btn"
                            onClick={() => {
      ...
      <section id="services" className="services-section" aria-labelledby="services-title">
        <Container>
          <Row>
            <Col lg={8} className="mx-auto text-center">
              <h2 id="services-title" className="section-title">專業服務項目</h2>
      ...
      <section id="cases" className="cases-section" aria-labelledby="cases-title">
        <Container>
          <Row>
            <Col lg={8} className="mx-auto text-center">
              <h2 id="cases-title" className="section-title">本公司服務流程</h2>
              <p className="section-description">
      ...
      <section id="contact" className="contact-section" aria-labelledby="contact-title">
        ...
        <div className="office-location">
          <h3 id="contact-title" className="location-title">誠泰地產管理有限公司</h3>
          ...
          <div className="location-content">
            <div className="location-info">
              ...
              <div className="info-item">
                ...
                <div className="info-value">403台灣臺中市西區台灣大道一段728號12樓</div>
              </div>
            ...
            <div className="location-map">
              <iframe
                title="誠泰地產管理有限公司位置地圖 - 台中市西區台灣大道一段728號"
          ...
          <Row>
            <Col lg={12} className="text-center">
              <div className="footer-brand">
                <img src={logoImage} alt="誠泰地產管理有限公司 - 31年專業工廠登記用地變更顧問服務" className="footer-logo" />
            ...
            {selectedCase?.images && selectedCase.images.length > 1 ? (
              <div className="case-image-gallery">
                <div className="image-controls">
                  <button
                    ...
                    onClick={() => setCurrentImageIndex(prev =>
                      prev > 0 ? prev - 1 : selectedCase.images.length - 1
                    )}
                    disabled={selectedCase.images.length <= 1}
                    type="button"
                  >
                    <span>← 上一頁</span>
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => setCurrentImageIndex(prev =>
                      prev < selectedCase.images.length - 1 ? prev + 1 : 0
                    )}
                    disabled={selectedCase.images.length <= 1}
                    type="button"
                  >
                ...
                <img
                  ...
                  alt={`${selectedCase.title} - 詳細案例圖片 第${currentImageIndex + 1}頁`}
                  className="case-modal-image"
                />
              </div>
            ) : (
              <img
                src={selectedCase?.images ? selectedCase.images[0] : selectedCase?.image}
                alt={`${selectedCase?.title} - 詳細案例圖片`}
                className="case-modal-image"
              />
            )}
          </div>
